package ru.javaprojects.mealservice.web.swagger;
...
@OpenAPIDefinition(
        info = @Info(
                title = "Energy Balance Control System. Meal Web Service Documentation",
                version = "1.0",
                description = "This page documents Meal Microservice RESTful Web Service endpoints<br><br>" +
