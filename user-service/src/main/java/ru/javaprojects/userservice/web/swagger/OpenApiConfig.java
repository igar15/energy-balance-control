...
@OpenAPIDefinition(
        info = @Info(
                title = "Energy Balance Control System. User Web Service Documentation",
                version = "1.0",
                description = "This page documents User Microservice RESTful Web Service endpoints<br><br>" +
