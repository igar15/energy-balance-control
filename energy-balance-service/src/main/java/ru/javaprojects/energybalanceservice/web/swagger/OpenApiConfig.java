package ru.javaprojects.energybalanceservice.web.swagger;
...
@OpenAPIDefinition(
        info = @Info(
                title = "Energy Balance Control System. Energy Balance Web Service Documentation",
                version = "1.0",
                description = "This page documents Energy Balance Microservice RESTful Web Service endpoints<br><br>" +
