...
import static ru.javaprojects.energybalanceservice.util.exception.ErrorType.ACCESS_DENIED_ERROR;
import static ru.javaprojects.energybalanceservice.web.AppExceptionHandler.EXCEPTION_ACCESS_DENIED;
