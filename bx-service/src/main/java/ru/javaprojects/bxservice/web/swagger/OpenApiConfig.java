package ru.javaprojects.bxservice.web.swagger;
...
@OpenAPIDefinition(
        info = @Info(
                title = "Energy Balance Control System. BX Web Service Documentation",
                version = "1.0",
                description = "This page documents BX Microservice RESTful Web Service endpoints<br><br>" +
