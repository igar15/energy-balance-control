...
public class AppExceptionHandler extends BasicAppExceptionHandler {
    ...
    @ExceptionHandler(UserServiceConnectionException.class)
    public ResponseEntity<ErrorInfo> feignError(HttpServletRequest req, UserServiceConnectionException e) {
        return logAndGetErrorInfo(req, e, false, FEIGN_ERROR);
    }
}